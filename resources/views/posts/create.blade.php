...
@section('contenido')
    <div class="md:flex md:items-center">
        <div class="md:w-1/2 px-10">
            <form action={{ route('imagenes.store') }} method="POST" enctype="multipart/form-data" id="dropzone" class="dropzone border-dash borde-2 w-full h-96 rounded flex flex-col justify-center items-center">
                @csrf
            </form>
        </div>
